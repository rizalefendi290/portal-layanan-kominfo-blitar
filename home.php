  ...
  <header>
    <nav class="bg-gray-800 text-white py-4">
      <div class="container mx-auto flex items-center justify-between px-4">
        <img src="image/logo.png.png" width="80" height="80" alt="Logo" class="mr-4">
  ...
  <main class="my-8">
    ...
    <section class="container mx-auto px-4">
      <div class="text-center mb-8">
        ...
        <p class="text-lg leading-relaxed">Kementerian Komunikasi dan Informatika (Kominfo) adalah lembaga pemerintah di Indonesia yang bertanggung jawab atas pengembangan, pengelolaan, dan pengawasan sektor komunikasi dan informatika. Tugas utamanya meliputi penyebaran informasi, pengembangan infrastruktur telekomunikasi, pengaturan media, serta peningkatan literasi digital. Kominfo juga berperan dalam mendukung transformasi digital dan menjaga keamanan cyber di tanah air.</p>
      </div>
        ...
        <div class="overflow-hidden">
          <div class="slider flex transition-transform duration-500 ease-in-out">
            <div class="w-full flex-shrink-0">
              <img src="image/kantor1.jpg" class="w-full object-cover" alt="Kantor 1">
            </div>
            <div class="w-full flex-shrink-0">
              <img src="image/kantor2.jpg" class="w-full object-cover" alt="Kantor 2">
            </div>
            <div class="w-full flex-shrink-0">
              <img src="image/kantor3.jpg" class="w-full object-cover" alt="Kantor 3">
            </div>
          </div>
        </div>
        <div class="absolute top-1/2 left-0 transform -translate-y-1/2 flex justify-between w-full px-4">
          <button class="bg-gray-800 text-white px-4 py-2 rounded-full" id="prev"><i class="fas fa-chevron-left"></i></button>
          <button class="bg-gray-800 text-white px-4 py-2 rounded-full" id="next"><i class="fas fa-chevron-right"></i></button>
        </div>
      ...
      <div class="text-center">
        ...
        <p class="text-lg mb-8">Kementerian Dinas Komunikasi dan Informatika (Diskominfo) berkomitmen untuk memberikan pelayanan terbaik kepada masyarakat. Berikut adalah layanan yang tersedia</p>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div class="bg-white p-6 rounded-lg shadow-lg">
            <h2 class="text-xl font-bold mb-2">Pengaduan Layanan</h2>
            <p class="mb-4">Masyarakat dapat mengajukan keluhan terkait layanan telekomunikasi melalui platform resmi kami.</p>
            <a href="kontak.html">
          ...
          <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p class="mb-4">Kami menyediakan informasi mengenai registrasi nomor telepon dan kewajiban pengguna untuk mendukung keamanan komunikasi.</p>
          ...
          <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p class="mb-4">Akses mudah untuk mendapatkan informasi yang transparan dan akuntabel sesuai dengan UU Keterbukaan Informasi.</p>
  ...
  <footer class="bg-gray-800 text-white py-8">
    <div class="container mx-auto flex flex-col lg:flex-row justify-between px-4">
      ...
      <div>
        ...
        <p>Dinas Komunikasi dan Informasi menyediakan berbagai macam layanan untuk memberikan informasi dan membantu rakyat Indonesia.</p>
        <div class="mt-4 flex space-x-4">
          <a href="https://www.youtube.com/channel/UC6673kwtPekbPTJgRsTSizQ" class="text-white"><i class="fab fa-youtube fa-2x"></i></a>
          <a href="https://id-id.facebook.com/Kemkominfo/" class="text-white"><i class="fab fa-facebook fa-2x"></i></a>
          <a href="https://x.com/kemkominfo" class="text-white"><i class="fab fa-twitter fa-2x"></i></a>
          <a href="https://www.instagram.com/kemenkominfo/?hl=id" class="text-white"><i class="fab fa-instagram fa-2x"></i></a>
        </div>
      </div>
    </div>
  </footer>
